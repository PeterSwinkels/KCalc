...
On Error GoTo Fout
   ...
   VVStelVensterIn Vis, Me, Me.Name
...
On Error GoTo Fout
   ...
   Vis.Meeteenheid = SelecteerMeeteenheid(Vis.Meeteenheid, VisVenster)
...
On Error GoTo Fout
   ...
   If Vis.Selectie = 0 Then ProductenLijst.Text = GEEN_PRODUCT_TEKST
   Gerecht.WijzigingenBewaard = False
