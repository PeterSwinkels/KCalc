VERSION 5.00
Begin VB.Form TafelgarnituurVenster 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ...
   End
End
Attribute VB_Name = "TafelgarnituurVenster"
...
On Error GoTo Fout
   ...
   BBDGMSTStelVensterIn Tafelgarnituur, Me, Me.Name
...
On Error GoTo Fout
   ...
   Tafelgarnituur.Productrij = Index
...
On Error GoTo Fout
   ...
   BewerkGetalVeld HoeveelheidVeld(Tafelgarnituur.Productrij), KeyAscii, MAX_HOEVEELHEID
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then HoeveelheidVeld(Tafelgarnituur.Productrij).Text = vbNullString
...
On Error GoTo Fout
   ...
   BBDGMSTVerwerkInvoer Tafelgarnituur, Me
...
On Error GoTo Fout
   ...
   Tafelgarnituur.Meeteenheid(Tafelgarnituur.Productrij) = SelecteerMeeteenheid(Tafelgarnituur.Meeteenheid(Tafelgarnituur.Productrij), TafelgarnituurVenster)
...
On Error GoTo Fout
   ...
   BewerkGetalVeld PrijsVeld(Tafelgarnituur.Productrij), KeyAscii, MAX_PRIJS, IsBedrag:=True
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then PrijsVeld(Tafelgarnituur.Productrij).Text = vbNullString
...
On Error GoTo Fout
   ...
   If Tafelgarnituur.Selectie(Tafelgarnituur.Productrij) = 0 Then ProductenLijst(Tafelgarnituur.Productrij).Text = GEEN_PRODUCT_TEKST
   Gerecht.WijzigingenBewaard = False
...
On Error GoTo Fout
   ...
   BewerkProductVeld ProductenLijst(Tafelgarnituur.Productrij), KeyAscii, MAX_PRODUCTNAAM_LENGTE
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then ProductenLijst(Tafelgarnituur.Productrij).Text = vbNullString
