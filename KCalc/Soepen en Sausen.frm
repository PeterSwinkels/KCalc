VERSION 5.00
Begin VB.Form SoepenEnSausenVenster 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ...
   Begin VB.Label KostprijsLabel 
      ...
      Width           =   1335
   End
   Begin VB.Label LiterprijsLabel 
      Appearance      =   0  'Flat
      BackColor       =   &H80000005&
      Caption         =   "Literprijs:"
      ForeColor       =   &H80000008&
   ...
   End
End
Attribute VB_Name = "SoepenEnSausenVenster"
...
On Error GoTo Fout
   ...
   BBDGMSTStelVensterIn SoepenEnSausen, Me, Me.Name
...
On Error GoTo Fout
   ...
   SoepenEnSausen.Productrij = Index
...
On Error GoTo Fout
   ...
   BewerkGetalVeld HoeveelheidVeld(SoepenEnSausen.Productrij), KeyAscii, MAX_HOEVEELHEID
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then HoeveelheidVeld(SoepenEnSausen.Productrij).Text = vbNullString
...
On Error GoTo Fout
   ...
   BBDGMSTVerwerkInvoer SoepenEnSausen, Me
...
On Error GoTo Fout
   ...
   SoepenEnSausen.Meeteenheid(SoepenEnSausen.Productrij) = SelecteerMeeteenheid(SoepenEnSausen.Meeteenheid(SoepenEnSausen.Productrij), SoepenEnSausenVenster)
...
On Error GoTo Fout
   ...
   BewerkGetalVeld PrijsVeld(SoepenEnSausen.Productrij), KeyAscii, MAX_PRIJS, IsBedrag:=True
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then PrijsVeld(SoepenEnSausen.Productrij).Text = vbNullString
...
On Error GoTo Fout
   ...
   If SoepenEnSausen.Selectie(SoepenEnSausen.Productrij) = 0 Then ProductenLijst(SoepenEnSausen.Productrij).Text = GEEN_PRODUCT_TEKST
   Gerecht.WijzigingenBewaard = False
...
On Error GoTo Fout
   ...
   BewerkProductVeld ProductenLijst(SoepenEnSausen.Productrij), KeyAscii, MAX_PRODUCTNAAM_LENGTE
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then ProductenLijst(SoepenEnSausen.Productrij).Text = vbNullString
