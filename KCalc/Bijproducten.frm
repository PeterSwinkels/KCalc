VERSION 5.00
Begin VB.Form BijproductenVenster 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ...
   End
End
Attribute VB_Name = "BijproductenVenster"
...
On Error GoTo Fout
   ...
   BBDGMSTStelVensterIn Bijproducten, Me, Me.Name
...
On Error GoTo Fout
   ...
   BewerkGetalVeld HoeveelheidVeld(Bijproducten.Productrij), KeyAscii, MAX_HOEVEELHEID
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then HoeveelheidVeld(Bijproducten.Productrij).Text = vbNullString
...
On Error GoTo Fout
   ...
   BBDGMSTVerwerkInvoer Bijproducten, Me
...
On Error GoTo Fout
   ...
   Bijproducten.Meeteenheid(Bijproducten.Productrij) = SelecteerMeeteenheid(Bijproducten.Meeteenheid(Bijproducten.Productrij), BijproductenVenster)
...
On Error GoTo Fout
   ...
   BewerkGetalVeld PrijsVeld(Bijproducten.Productrij), KeyAscii, MAX_PRIJS, IsBedrag:=True
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then PrijsVeld(Bijproducten.Productrij).Text = vbNullString
...
On Error GoTo Fout
   ...
   If Bijproducten.Selectie(Bijproducten.Productrij) = 0 Then ProductenLijst(Bijproducten.Productrij).Text = GEEN_PRODUCT_TEKST
   Gerecht.WijzigingenBewaard = False
...
On Error GoTo Fout
   ...
   BewerkProductVeld ProductenLijst(Bijproducten.Productrij), KeyAscii, MAX_PRODUCTNAAM_LENGTE
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then ProductenLijst(Bijproducten.Productrij).Text = vbNullString
