...
Begin VB.Form GroentenVenster 
   ...
   End
End
Attribute VB_Name = "GroentenVenster"
...
On Error GoTo Fout
   ...
   BBDGMSTStelVensterIn Groenten, Me, Me.Name
...
On Error GoTo Fout
   ...
   BewerkGetalVeld HoeveelheidVeld(Groenten.Productrij), KeyAscii, MAX_HOEVEELHEID
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then HoeveelheidVeld(Groenten.Productrij).Text = vbNullString
...
On Error GoTo Fout
   ...
   BBDGMSTVerwerkInvoer Groenten, Me
...
On Error GoTo Fout
   ...
   Groenten.Meeteenheid(Groenten.Productrij) = SelecteerMeeteenheid(Groenten.Meeteenheid(Groenten.Productrij), GroentenVenster)
...
On Error GoTo Fout
   ...
   BewerkGetalVeld PrijsVeld(Groenten.Productrij), KeyAscii, MAX_PRIJS, IsBedrag:=True
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then PrijsVeld(Groenten.Productrij).Text = vbNullString
...
On Error GoTo Fout
   ...
   If Groenten.Selectie(Groenten.Productrij) = 0 Then ProductenLijst(Groenten.Productrij).Text = GEEN_PRODUCT_TEKST
   Gerecht.WijzigingenBewaard = False
...
On Error GoTo Fout
   ...
   BewerkProductVeld ProductenLijst(Groenten.Productrij), KeyAscii, MAX_PRODUCTNAAM_LENGTE
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then ProductenLijst(Groenten.Productrij).Text = vbNullString
