VERSION 5.00
Begin VB.Form BittergarnituurVenster 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ...
   End
End
Attribute VB_Name = "BittergarnituurVenster"
...
On Error GoTo Fout
   ...
   BBDGMSTStelVensterIn Bittergarnituur, Me, Me.Name
...
On Error GoTo Fout
   ...
   Bittergarnituur.Productrij = Index
...
On Error GoTo Fout
   ...
   BewerkGetalVeld HoeveelheidVeld(Bittergarnituur.Productrij), KeyAscii, MAX_HOEVEELHEID
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then HoeveelheidVeld(Bittergarnituur.Productrij).Text = vbNullString
...
On Error GoTo Fout
   ...
   BBDGMSTVerwerkInvoer Bittergarnituur, Me
...
On Error GoTo Fout
   ...
   Bittergarnituur.Meeteenheid(Bittergarnituur.Productrij) = SelecteerMeeteenheid(Bittergarnituur.Meeteenheid(Bittergarnituur.Productrij), BittergarnituurVenster)
...
On Error GoTo Fout
   ...
   BewerkGetalVeld PrijsVeld(Bittergarnituur.Productrij), KeyAscii, MAX_PRIJS, IsBedrag:=True
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then PrijsVeld(Bittergarnituur.Productrij).Text = vbNullString
...
On Error GoTo Fout
   ...
   If Bittergarnituur.Selectie(Bittergarnituur.Productrij) = 0 Then ProductenLijst(Bittergarnituur.Productrij).Text = GEEN_PRODUCT_TEKST
   Gerecht.WijzigingenBewaard = False
...
On Error GoTo Fout
   ...
   BewerkProductVeld ProductenLijst(Bittergarnituur.Productrij), KeyAscii, MAX_PRODUCTNAAM_LENGTE
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then ProductenLijst(Bittergarnituur.Productrij).Text = vbNullString
