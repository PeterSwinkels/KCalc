VERSION 5.00
Begin VB.Form MeelspijzenVenster 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ...
   End
End
Attribute VB_Name = "MeelspijzenVenster"
...
On Error GoTo Fout
   ...
   BBDGMSTStelVensterIn Meelspijzen, Me, Me.Name
...
On Error GoTo Fout
   ...
   BewerkGetalVeld HoeveelheidVeld(Meelspijzen.Productrij), KeyAscii, MAX_HOEVEELHEID
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then HoeveelheidVeld(Meelspijzen.Productrij).Text = vbNullString
...
On Error GoTo Fout
   ...
   BBDGMSTVerwerkInvoer Meelspijzen, Me
...
On Error GoTo Fout
   ...
   Meelspijzen.Meeteenheid(Meelspijzen.Productrij) = SelecteerMeeteenheid(Meelspijzen.Meeteenheid(Meelspijzen.Productrij), MeelspijzenVenster)
...
On Error GoTo Fout
   ...
   BewerkGetalVeld PrijsVeld(Meelspijzen.Productrij), KeyAscii, MAX_PRIJS, IsBedrag:=True
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then PrijsVeld(Meelspijzen.Productrij).Text = vbNullString
...
On Error GoTo Fout
   ...
   If Meelspijzen.Selectie(Meelspijzen.Productrij) = 0 Then ProductenLijst(Meelspijzen.Productrij).Text = GEEN_PRODUCT_TEKST
   Gerecht.WijzigingenBewaard = False
...
On Error GoTo Fout
   ...
   BewerkProductVeld ProductenLijst(Meelspijzen.Productrij), KeyAscii, MAX_PRODUCTNAAM_LENGTE
...
On Error GoTo Fout
   ...
   If KeyCode = vbKeyDelete Then ProductenLijst(Meelspijzen.Productrij).Text = vbNullString
